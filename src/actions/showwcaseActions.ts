...
// export function fetchAllSchools(subject: any): ShowwcaseActionTypes {
//   axios
//   .get(`http://universities.hipolabs.com/search?name=${subject}`)
//   .then(response => {
//     return { type: FETCH_ALL_SCHOOLS, data: response.data }
//     }
//   )
...
export function setEducation(educationObj: EducationState): ShowwcaseActionTypes {
  return{ type: SET_EDUCATION, data: educationObj};
}
